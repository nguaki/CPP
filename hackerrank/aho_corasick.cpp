...
int buildMatchingMachine(const vector<string> &words, char lowestChar = '0', char highestChar = '9') {
...
int main(){
    ...
    **/
    ...
    keywords.push_back("4");
    keywords.push_back("8");
    keywords.push_back("16");
    keywords.push_back("32");
    keywords.push_back("64");
    keywords.push_back("128");
    keywords.push_back("256");
    string text = "224256";
    //string text = "2222222";
   
    
    buildMatchingMachine(keywords, '0', '9');
    int currentState = 0;
    for (int i = 0; i < text.size(); ++i) {
